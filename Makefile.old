# This Makefile is for the Maypole::Loader extension to perl.
#
...
INST_LIBDIR      = $(INST_LIB)/Maypole
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Maypole
...
DISTNAME = Maypole-Loader
DISTVNAME = Maypole-Loader-0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Loader.pm $(INST_MAN3DIR)/Maypole::Loader.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Loader.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Loader' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Loader.pm $(INST_LIB)/Maypole/Loader.pm 
	$(NOECHO) $(TOUCH) $@
